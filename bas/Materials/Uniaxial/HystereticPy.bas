...
ops.uniaxialMaterial('Hysteretic', *MaterialID, *MatProp(Stress_s1p,real), *MatProp(Strain_e1p,real), *MatProp(Stress_s2p,real), *MatProp(Strain_e2p,real), *\
*format "%g%g%g%g"
...
ops.uniaxialMaterial('Hysteretic', *MaterialID, *MatProp(Force_s1p,real), *MatProp(Displacement_e1p,real), *MatProp(Force_s2p,real), *MatProp(Displacement_e2p,real), *\
*format "%g%g%g%g"
...
*else
ops.uniaxialMaterial('Hysteretic', *MaterialID, *MatProp(Moment_s1p,real), *MatProp(Rotation_e1p,real), *MatProp(Moment_s2p,real), *MatProp(Rotation_e2p,real), *\
*format "%g%g%g%g"
