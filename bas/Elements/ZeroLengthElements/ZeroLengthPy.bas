...
*include ..\..\Materials\Uniaxial\ViscousDamperPy.bas
...
*include ..\..\Materials\Uniaxial\HyperbolicGapPy.bas
*elseif(strcmp(MatProp(Material:),"PySimple1")==0)
*include ..\..\Materials\Uniaxial\PySimple1Py.bas
*elseif(strcmp(MatProp(Material:),"TzSimple1")==0)
*include ..\..\Materials\Uniaxial\TzSimple1Py.bas
*elseif(strcmp(MatProp(Material:),"QzSimple1")==0)
*include ..\..\Materials\Uniaxial\QzSimple1Py.bas
*elseif(strcmp(MatProp(Material:),"BondSP01")==0)
*include ..\..\Materials\Uniaxial\BondSP01Py.bas
*#
...
*end nodes
*if(ZLNodes==1)
*MessageBox Error: ZeroLength Element with only 1 node. ZeroLength elements must be assigned to at least 2 nodes. Also check if you have assigned ZeroLength between nodes with different DOFs. ZeroLength Elements nodes MUST have the same number of DOFs.
*endif
...
*format "%6d%6d%6d"
ops.element('zeroLength', *ZeroLengthElemTag, *ZeroLengthFirstNode, *ZeroLengthSecondNode, *\
'-mat', *\
*loop nodes *OnlyInCond
*set var nodeDOF=tcl(ReturnNodeGroupDOF *NodesNum)
*if(nodeDOF==currentDOF)
